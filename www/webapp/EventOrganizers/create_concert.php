...
<?php
    ...
    function Body(){
        echo    '<div class="container-fluid p-2 bd-highlight">
                    <form action="store_concert.php" method="post" class="was-validated">
                        ...
                        <div class="form-floating mt-3 mb-3">
                            <input type="text" class="form-control" id="artist" placeholder="Enter Artist" name="artist" required>
