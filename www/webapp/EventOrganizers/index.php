...
<?php
                ...
                <div class=\"col\">
                    <div class=\"dropdown\">
                        ...
                        <ul class=\"dropdown-menu\">
                            <li><a class=\"dropdown-item\" href=\"./create_concert.php\">Create Event</a></li>
    ...
    function EventCard($id, $title, $date, $artist, $category){
        $result =  '<div class="card"   id='.$id.'>
                        <div class="card-body">
                            ...
                            <a href="./edit.php?id='.$id.'&title='.$title.'&date='.$date.'&artist='.$artist.'&category='.$category.'" class="btn btn-dark">Edit</a>
                            <a onclick="deleteEvent(\''.$id.'\')" class="btn btn-danger">Delete</a>
                        </div>
                    </div>';
    ...
    function getConcerts(){
        ...
        curl_setopt($ch, CURLOPT_URL,"http://172.18.1.11/getConcerts.php?username=".$_SESSION['username']);
